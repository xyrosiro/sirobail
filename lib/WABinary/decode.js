...
exports.decompressingIfRequired = exports.decodeDecompressedBinaryNode = exports.decodeBinaryNode = void 0;
...
const decodeDecompressedBinaryNode = (buffer, opts, indexRef = {
  ...
  const readAdJid = () => {
    ...
    if (domainType === _jidUtils.WAJIDDomains.LID) {
      server = 'lid';
    } else if (domainType === _jidUtils.WAJIDDomains.HOSTED) {
      server = 'hosted';
    } else if (domainType === _jidUtils.WAJIDDomains.HOSTED_LID) {
      server = 'hosted.lid';
    }
